...
@WebServlet(urlPatterns= {"/pinion_shaft1GraphView"})
public class PinionShaftGraphViewServlet extends HttpServlet {
	
	private static final long serialVersionUID = 1L;
	
	public PinionShaftGraphViewServlet() {
		super();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.setAttribute("machineName", "PINION SHAFT 1");
		...
		RequestDispatcher dispatcher = request.getServletContext().getRequestDispatcher("/WEB-INF/views/pinionShaftGraphView.jsp");
